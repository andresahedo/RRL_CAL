...
public class DocumentoLazyModelOpcionalCall extends LazyDataModel<DocumentoDTO>{
    ...
    public DocumentoLazyModelOpcionalCall(ConsultasAutorizacionesCALBusiness consultasBussines2) {
    ...
    public List<DocumentoDTO> load(int first, int pageSize, String sortField, SortOrder sortOrder,
        ...
        if (filters.size() > 0) {
            ...
            DataPage dataPage = (DataPage) getConsultasAutorizacionesCALBusiness().obtenerDocumentosOpcionalesLazy(filters.get("idSolicitud").toString());
