 ...
 */
@SessionScoped
@ManagedBean(name = "autorizarRemisionCALController")
public class AutorizarRemisionCALController extends BaseControllerBean {
     ...
     * Constructor vacio.
     */
    public AutorizarRemisionCALController() {
    ...
    public void prepararAutorizarRemision(DatosBandejaTareaDTO datosBandejaTareaDTO) {
        ...
        getFlash().put("idSolicitud", getDatosBandejaTareaDTO().getIdSolicitud());
        getFlash().put("tipoTramite", getDatosBandejaTareaDTO().getTipoTramite());
