...
public class TareaDTO extends BaseModel {

    private static final long serialVersionUID = 7560840905910475456L;
    ...
    /**
     * @param fechaAsignacionRequerimiento
     *            the fechaAsignacionRequerimiento to set
     */
    public void setFechaAsignacionRequerimiento(Date fechaAsignacionRequerimiento) {
        this.fechaAsignacionRequerimiento =
                (null == fechaAsignacionRequerimiento ? null : (Date) fechaAsignacionRequerimiento.clone());
    }
