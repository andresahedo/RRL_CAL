...
@Entity
@DiscriminatorValue(value = DiscriminadorConstants.T2_AVISO_ACTUALIZACION_MONEDEROS_ELECTRONICOS)
public class SolicitudAvisoActualizarMonederoElectronico extends SolicitudConsultaAutorizacion {
     ...
     */
    @Transient
    private String discriminatorValue = DiscriminadorConstants.T2_AVISO_ACTUALIZACION_MONEDEROS_ELECTRONICOS;
