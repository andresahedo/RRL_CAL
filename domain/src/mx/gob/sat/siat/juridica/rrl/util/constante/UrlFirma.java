...
public enum UrlFirma {
    ...
    PAGINA_FIRMA_SOLICITUD_CAL_OP, PAGINA_FIRMA_RECHAZO_DOCUMENTO_OFICIALIA, PAGINA_FIRMA_DOCUMENTO_OFICIALIA, PAGINA_FIRMA_FALTANTES, PAGINA_FIRMA_FALTANTES_CAL;
